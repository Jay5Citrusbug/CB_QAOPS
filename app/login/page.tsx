...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen lg:h-screen lg:max-h-screen w-full bg-[#f8fafc] relative flex flex-col lg:flex-row items-center justify-between p-6 md:p-10 lg:p-6 xl:p-8 2xl:p-10 overflow-y-auto lg:overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between lg:h-full lg:max-h-[85vh] lg:min-h-0 z-10 text-slate-800 pr-12">
        {/* Top Header branding */}
      ...
      <div className="w-full lg:w-[45%] xl:w-[40%] flex items-center justify-center z-10">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 xl:space-y-3.5 2xl:space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-2.5 px-4 xl:py-2.5 xl:px-4 2xl:py-3 2xl:px-5 rounded-xl font-bold text-white shadow-xl flex items-center justify-center transition-all cursor-pointer text-xs xl:text-sm ${
                  loading 
